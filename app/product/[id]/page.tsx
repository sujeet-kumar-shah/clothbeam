...
const getProductDetails = (id: string) => {
  const products = {
    "1": {
      ...
      description: "Experience the epitome of luxury with our Emerald Green Silk Kurta. Handcrafted from pure raw silk, it features intricate gold embroidery on the collar and cuffs. Perfect for festive occasions and pre-wedding ceremonies. The breathable fabric ensures comfort while maintaining a regal appearance.",
      features: [
        "100% Pure Raw Silk",
        "Hand-embroidered zardosi work",
        "Mandarin collar with concealed placket",
        "Includes matching churidar pajama",
        "Dry clean only"
      ],
      images: [
  ...
  return products[id as keyof typeof products] || {
      name: "Premium Signature Apparel",
      price: 5999,
      category: "Luxury Fashion",
      description: "Elevate your style with this meticulously crafted piece from Clothbeam. Designed to offer both supreme comfort and a flawless fit, making it an essential addition to your sophisticated wardrobe.",
      features: [
      ...
      images: [
        "https://picsum.photos/seed/signature/800/1000"
      ],
      sizes: ["S", "M", "L", "XL"],
      inStock: true,
  };
